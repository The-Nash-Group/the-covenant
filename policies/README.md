...
- **[Identity and Account Management](./specs/identity-and-account-management.md)** (DRAFT v0.1.0 — Accepted for Validation 2026-05-03) - Multi-entity identity contract: per-entity provider account model, credential vault structure, principals, rotation, audit, and cross-entity prevention; narrow scope; ACTIVE promotion gated on first end-to-end migration validation (D5 step 7)
